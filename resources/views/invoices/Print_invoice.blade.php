                    ...
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6>Ziad Alariqii</h6>
                                    <p>Yemen, Sana'a Zero Street, next to Haddah Factory<br>
                                        Tel No: 775932431 <br>
                                        Email: ziadwahid2024@gmail.com</p>
                                </div>
                            </div>
                            <div class="col-md">
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <!-- كود حق العلامة الفاصلة بين الارقام  number_format-->
